# How to build and release Maven projects on the Camunda Community Hub
...
1. Use the *auto release property* in your Github workflow, so that all releases will be automatically be released to Maven Central:
